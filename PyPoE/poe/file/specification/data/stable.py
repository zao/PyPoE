...
specification = Specification({
    ...
    'GroundEffectEffectTypes.dat': File(
        fields=(
    ...
    'NPCTextAudioInterruptRules.dat': File(
        fields=(
    ...
    'SkillMorphDisplayOverlayCondition.dat': File(
        fields=(

        ),
    ),
    'SkillMorphDisplayOverlayStyle.dat': File(
        fields=(
