...
class AbstractFileReadOnly(ReprMixin):
    ...
    def get_read_buffer(
        self, file_path_or_raw: Union[BytesIO, bytes, str], function: Callable, *args, **kwargs
    ) -> Any:
        """
    ...
    def read(self, file_path_or_raw: Union[BytesIO, bytes, str], *args, **kwargs) -> Any:
        """
...
class AbstractFile(AbstractFileReadOnly):
    ...
    def write(self, file_path_or_raw: Union[BytesIO, bytes, str], *args, **kwargs) -> Any:
        """
...
class AbstractFileSystemNode(ReprMixin):
    ...
    def __init__(
        self, parent: "FileSystemNode", file_system_type: FILE_SYSTEM_TYPES, is_file: bool
    ):
